...
#kafka-topics --create --topic connect-configs --bootstrap-server kafka1:9092 --partitions 1 --replication-factor 1  --config cleanup.policy=compact
#kafka-topics --create --topic connect-offsets --bootstrap-server kafka1:9092 --partitions 50 --replication-factor 1 --config cleanup.policy=compact
#kafka-topics --create --topic connect-status --bootstrap-server kafka1:9092 --partitions 10 --replication-factor 1  --config cleanup.policy=compact

#kafka-topics --create --topic connect-configs --bootstrap-server kafka2:9093 --partitions 1 --replication-factor 1  --config cleanup.policy=compact
#kafka-topics --create --topic connect-offsets --bootstrap-server kafka2:9093 --partitions 50 --replication-factor 1 --config cleanup.policy=compact
#kafka-topics --create --topic connect-status --bootstrap-server kafka2:9093 --partitions 10 --replication-factor 1  --config cleanup.policy=compact
